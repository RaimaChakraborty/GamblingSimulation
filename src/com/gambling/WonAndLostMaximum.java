...
public class WonAndLostMaximum {
    ...
    public void luck()
    {
        ...
        {                                // The gambler plays for a month
            ...
            while ((dailyAmount < upperMargin) && (dailyAmount > lowerMargin) && (betPlayed < EveryDayStake))
            {
                ...
                if (luckyDayAmount < dailyAmount)
                {                         //Checking the condition for lucky days
                    luckyDayAmount = dailyAmount;
                    luckyDay = i;
                } else if (unluckyDayAmount > dailyAmount)
                {                  //Checking the condition for unlucky days
    ...
    public static void main(String[] args)
    {
        ...
        WonAndLostMaximum simulation = new WonAndLostMaximum();                     //Creating a new object
        simulation.luck();                                            //Calling the method (UC6)
    }
}
